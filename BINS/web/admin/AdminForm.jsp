...
<%@ page info="Modulo Amministratore" %>
...
<html lang="it">
  ...
  <body class="sidebar-collapsible sidebar-open">
                  ...
                  <div class="st-panel st-panel--border">
                    <div class="st-panel__cont">
                      ...
                      <div class="st-panel__header">
                        <div class="fluid-cols">
                          <div class="expand-col text-ellipsis"><span class="st-panel__title">Inserisci Amministratore</span></div>
                          <div class="min-col">
                          ...
                          <div class="tab-pane active" role="tabpanel" id="info">
                            <div class="form-horizontal">
                              ...
                              <div class="form-group">
                                <label class="col-sm-2 mb control-label">Email</label>
                                <div class="col-sm-10 mb">
                                  <input class="form-control" type="text" placeholder="email@bins.com">
                                </div>
                              </div>
                              
                              <!-- Password -->
                              <div class="form-group">
                                <label class="col-sm-2 mb control-label">Password</label>
                                <div class="col-sm-10 mb">
                              ...
                              <!-- Nome -->
                              <div class="form-group">
                                <label class="col-sm-2 mb control-label">Nome</label>
                                <div class="col-sm-10 mb">
                              ...
                              <!-- Cognome -->
                              <div class="form-group">
                                <label class="col-sm-2 mb control-label">Cognome</label>
                                <div class="col-sm-10 mb">
                              ...
                              <!-- Data di nascita -->
                              <div class="form-group">
                                <label class="col-sm-2 mb control-label">Data di nascita</label>
                                <div class="col-sm-2 mb">
                                  <input class="form-control" type="text" placeholder="13/12/1993">
                                </div>
                              </div>
                              
                              <!-- Codice Fiscale -->
                              <div class="form-group">
                                <label class="col-sm-2 mb control-label">Codice Fiscale</label>
                                <div class="col-sm-10 mb">
                                  <input class="form-control" type="text" placeholder="Codice Fiscale">
                                </div>
                              </div>
                              ...
                              <div class="form-group">
                                ...
                                <div class="radio radio-inline">
                                  <input id="si" type="radio" name="controls_radio" checked="checked">
                                  <label for="si">S&igrave;</label>
                                </div>
                                <div class="radio radio-inline">
                                  <input id="no" type="radio" name="controls_radio">
    ...
    <script src="js/modules/pages/adminForm.js"></script>
