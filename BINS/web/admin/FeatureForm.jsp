<%-- 
    Document   : FeatureForm
    Author     : Michele
--%>

<%@ page info="Modulo Caratteristica" %>
                  ...
                  <div class="st-panel st-panel--border">
                    <div class="st-panel__cont">
                      ...
                      <div class="st-panel__header">
                        <div class="fluid-cols">
                          <div class="expand-col text-ellipsis"><span class="st-panel__title">Inserisci Caratteristica</span></div>
                        </div>
                      </div>
                          ...
                          <div class="tab-pane active" role="tabpanel" id="info">
                            <div class="form-horizontal">
                              ...
                              <div class="form-group">
                                <label class="col-sm-2 mb control-label">Nome Caratteristica</label>
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-10 mb">
                                  <textarea class="form-control noresize" placeholder="Descrizione Caratteristica" rows="5" style="height: 112px;"></textarea>
                                </div>
                              </div>
