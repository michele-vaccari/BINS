...
<html lang="it">
  ...
  <body class="sidebar-collapsible sidebar-open">
                ...
                <div class="st-panel">
                  <div class="st-panel__cont">
                    ...
                    <div class="st-panel__header">
                      <div class="fluid-cols">
                        <div class="expand-col text-ellipsis"><span class="st-panel__title"><span>Marche</span><small id="brands-info"></small></span></div>
                        <div class="min-col">
                          <div class="st-panel__form">
                            <div class="st-inputbar hidden-xs">
                              <div class="st-inputbar-input hidden-xs">
                                <input class="form-control input-sm" id="brands-search" type="text" placeholder="Cerca" style="width: 200px;">
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="st-panel__content">
                      <div class="table-responsive table-responsive-bordered avoid-flicker" width="100%">
                        <table class="table table-bordered table-filled table-striped table-hover" id="brands-table" width="100%">
                          ...
                          <tbody>
                            ...
                            <tr data-brand="Marchio1">
                              ...
                              <td class="text-center st-brands__action">
                                <div class="btn-group dropdown"><a class="btn btn-default btn-xs" href="#">Visualizza</a>
                                  ...
                                  <ul class="dropdown-menu dropdown-menu-right">
                                    <li><a class="brands-edit" data-brand="Marchio1">Modifica</a></li>
                                    <li><a class="brands-remove" data-brand="Marchio1">Elimina</a></li>
                                  </ul>
                                </div>
                              </td>
                            </tr>
                            
                            <tr data-brand="Marchio2">
                              ...
                              <td class="text-center st-brands__action">
                                <div class="btn-group dropdown"><a class="btn btn-default btn-xs" href="#">Visualizza</a>
                                  <button class="btn btn-default btn-xs dropdown-toggle" type="button" data-toggle="dropdown" data-container="body"><span class="caret"></span></button>
                                  <ul class="dropdown-menu dropdown-menu-right">
                                    <li><a class="brands-edit" data-brand="Marchio2">Modifica</a></li>
                                    <li><a class="brands-remove" data-brand="Marchio2">Elimina</a></li>
                                  </ul>
                                </div>
                              </td>
                            </tr>
                      ...
                      <div class="st-users__footer clearfix">
                        <div class="pull-left">
                          <div class="select2-sm select2-contented">
                            <select class="form-control" id="brands-length" style="width: auto;" data-minimum-results-for-search="Infinity" data-dropdown-css-class="contented">
                        ...
                        <div class="pull-right">
                          <div class="pagination-sm" id="brands-pagination"></div>
                        </div>
                      </div>
    ...
    <script src="js/modules/pages/brandView.js"></script>
